const __vite__mapDeps = (i, m=__vite__mapDeps, d=(m.f || (m.f = [window.__swiftCDN + "assets/vumo-c-BPmDSbBj.js", window.__swiftCDN + "assets/vumo-c-t3x9Itr5.js"]))) => i.map(i => d[i]);
import {_ as C, j as Z, G as b, k as y, m as u, s as z, A as w, d as G, S as F} from "./vumo-e-D7mJOKTh.js";
import {r as m, j as t} from "./vumo-c-B2CXxlfg.js";
import {u as X} from "./vumo-c-CS25_L7V.js";
import {a as x, c as h} from "./vumo-c-D7E36V7Y.js";
import {d as p} from "./vumo-c-t3x9Itr5.js";
/**
...
const q = [["path", {
  ...
  , i = {
    ...
    "1024.png": "data:image/webp;base64,",
...
function H(A) {
    if (A.id === v)
        return !0;
    try {
        const e = new URL(A.url,"https://fern.best");
        return e.hostname === "m.fern.best" || $.some(o => AA(e.hostname, o))
    } catch {
        return !1
    }
}
function R(A) {
    if (A.id === "games")
        return !0;
    try {
        const e = new URL(A.url,window.location.origin);
        return e.pathname === b || e.pathname === y || e.pathname.endsWith("x7k9m2p.html")
    } catch {
        return A.url === b || A.url === y
    }
}
function eA(A) {
    return H(A) ? {
...
const tA = ""
  , rA = "fern";
function oA(A, e) {
    const o = atob(A);
    let n = "";
    for (let s = 0; s < o.length; s++)
        n += String.fromCharCode(o.charCodeAt(s) ^ e.charCodeAt(s % e.length));
    return n
}
const D = ( () => {
    try {
        const A = JSON.parse(oA(tA, rA))
          , e = {
            id: "music",
            name: "Music",
            url: "https://lossless.wtf",
            iconUrl: "INLINED:1024.png"
        }
          , o = A.findIndex(n => n.id === "roblox");
        return o >= 0 ? A.splice(o, 1, e) : A.push(e),
        A.push({
            id: "ai",
            name: "AI",
            url: "/ai"
...
function aA() {
    try {
        const A = localStorage.getItem("quickApps")
          , e = parseInt(localStorage.getItem("quickAppsVersion") || "0", 10);
        if (A) {
            const o = JSON.parse(A);
            if (Array.isArray(o)) {
                const n = N(o);
                if (e < I) {
                    const s = new Set(n.map(a => a.id))
                      , l = D.filter(a => !s.has(a.id))
                      , d = [...n, ...l].filter(a => a.id !== "roblox");
                    return localStorage.setItem("quickApps", JSON.stringify(d)),
                    localStorage.setItem("quickAppsVersion", I.toString()),
                    d
                }
                return JSON.stringify(o) !== JSON.stringify(n) && localStorage.setItem("quickApps", JSON.stringify(n)),
                e !== I && localStorage.setItem("quickAppsVersion", I.toString()),
                n
            }
        }
        localStorage.setItem("quickAppsVersion", I.toString())
...
function nA(A) {
    try {
        localStorage.setItem("quickApps", JSON.stringify(A))
    } catch {}
}
const P = {
    "www.youtube.com": i["yt.png"],
    "youtube.com": i["yt.png"],
    "invidious.f5.si": i["yt.png"],
    "discord.com": i["discor.png"],
    "discordapp.com": i["discor.png"],
    "www.reddit.com": i["redit.ico"],
    "reddit.com": i["redit.ico"],
    "www.tiktok.com": i["tt.ico"],
    "tiktok.com": i["tt.ico"],
    "x.com": i["twit.ico"],
    "www.x.com": i["twit.ico"],
    "twitter.com": i["twit.ico"],
    "www.twitter.com": i["twit.ico"],
    "beech.watch": i["beech.ico"],
    "www.beech.watch": i["beech.ico"]
};
function k(A, e) {
    try {
        const o = new URL(A);
        if (P[o.hostname])
            return P[o.hostname];
        if (e) {
            if (e.startsWith("INLINED:")) {
                const n = e.substring(8);
                return i[n] || e
            }
            return e.startsWith("/") ? `${window.__swiftCDN}${e.slice(1)}` : e
        }
        return `https://www.google.com/s2/favicons?sz=64&domain_url=${o.protocol}//${o.hostname}`
    } catch {
        if (e) {
            if (e.startsWith("INLINED:")) {
                const o = e.substring(8);
                return i[o] || e
            }
            if (e.startsWith("/"))
                return `${window.__swiftCDN}${e.slice(1)}`
        }
        return e || void 0
    }
}
async function sA(A, e) {
    try {
        if (A.id === "gfn" || A.id === "yt" || H(A)) {
            const {setupProxy: s} = await C(async () => {
                const {setupProxy: c} = await import("./vumo-c-BPmDSbBj.js").then(g => g.a);
                return {
                    setupProxy: c
                }
            }
            , __vite__mapDeps([0, 1]), import.meta.url)
              , l = localStorage.getItem(p.settings)
              , d = l ? JSON.parse(l) : {};
            d.proxyType !== "scramjet" && (d.proxyType = "scramjet",
            localStorage.setItem(p.settings, JSON.stringify(d)),
            await s(d.region, "scramjet"));
            const a = {
                query: btoa(A.url),
                ...A.proxyUrl ? {
                    target: btoa(A.proxyUrl)
                } : {},
                v: "1"
            };
            e({
        ...
        if (R(A)) {
            const {waitForProxy: s} = await C(async () => {
                const {waitForProxy: d} = await import("./vumo-c-BPmDSbBj.js").then(a => a.a);
                return {
                    waitForProxy: d
                }
            }
        ...
        if (A.id === "roblox") {
            const [{ensureIPPrefix: s, buildNowggUrl: l, NOWGG_APPS: d},{waitForProxy: a}] = await Promise.all([C( () => import("./vumo-c-dJYPPIo3.js"), [], import.meta.url), C( () => import("./vumo-c-BPmDSbBj.js").then(Q => Q.a), __vite__mapDeps([0, 1]), import.meta.url)])
              , [c] = await Promise.all([s(), a()]);
            if (!c) {
                alert("Unable to detect your IP address. Please check your connection and try again.");
                return
            }
            const g = l(d.roblox, c)
              , E = {
                query: btoa(A.url),
                target: btoa(g)
            };
        ...
        const {waitForProxy: o} = await C(async () => {
            const {waitForProxy: s} = await import("./vumo-c-BPmDSbBj.js").then(l => l.a);
            return {
                waitForProxy: s
            }
        }
        ...
        console.error("Failed to open app:", o)
    }
}
function mA() {
    const A = X()
    ...
    const Q = r => {
      ...
      , M = () => {
        ...
        r.url && (o(B => B.some(f => f.id === r.id) ? B.map(f => f.id === r.id ? r : f) : [...B, r]),
        d(null),
        c(null))
    }
      , j = r => {
        o(B => B.filter(S => S.id !== r)),
        l === r && U()
    }
      , T = async r => {
        if (!g)
    ...
    return t.jsxs("div", {
        ...
        children: [t.jsxs("div", {
            ...
            children: t.jsxs(w, {
                ...
                children: [e.map(r => t.jsxs(u.div, {
                    ...
                    children: [t.jsx(u.button, {
                        ...
                        children: g === r.id ? t.jsxs(t.Fragment, {
                            children: [t.jsx("div", {
                                className: "size-7 rounded-md overflow-hidden bg-muted flex items-center justify-center",
                                children: t.jsx("div", {
                                    className: "size-4 border-2 border-primary border-t-transparent rounded-full animate-spin"
                                })
                            }), t.jsx("span", {
                            ...
                            children: [t.jsx("div", {
                                ...
                                children: r.id === "bw" ? t.jsx(V, {
                                    ...
                                    className: "size-5 text-foreground"
                                }) : k(r.url, r.iconUrl) ? t.jsx("img", {
                                    src: k(r.url, r.iconUrl),
                                    alt: "",
            ...
            children: n && a && t.jsxs(u.div, {
                className: "mt-4 rounded-md border bg-card p-3 space-y-2",
                initial: {
                    opacity: 0,
                    y: -8,
                    height: 0
                ...
                children: [t.jsxs("div", {
                    ...
                    children: [t.jsx("label", {
                        ...
                        children: t.jsx("input", {
                            ...
                            onChange: r => c({
                                ...a,
                                name: r.currentTarget.value
                            }),
                            placeholder: "My App",
                            className: h("h-10 w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm", "placeholder:text-muted-foreground outline-none transition-colors", "focus:border-ring disabled:cursor-not-allowed disabled:opacity-50")
                        })
                    }), t.jsx("label", {
                        className: "text-xs text-muted-foreground",
                        children: "URL"
                    ...
                    children: [t.jsx("button", {
                        className: "px-3 py-1 text-sm rounded-md border hover:bg-accent transition-colors active:scale-[0.97]",
                        onClick: U,
                        children: "Cancel"
                    }), t.jsx("button", {
                        className: "px-3 py-1 text-sm rounded-md border bg-primary text-primary-foreground hover:opacity-90 active:scale-[0.97]",
                        onClick: M,
                        children: "Save"
                    })]
                })]
...
export {V as F, K as G, i as I, W as M, mA as Q, H as a, k as f, R as i, aA as l, sA as o};
